      ...
      <div className = "about-container">
        <div className = "about-wrapper">
          ...
          <div className='about-text-box'>
            ...
            <p className='about-text-p'>Hello there, my name is Christine and I'm from New York City! I'm an undergraduate student at Barnard College of Columbia University in the City of New York where I major in Computer Science with a minor in Psychology.‍<br></br>
            <br></br>During my free time, I immerse myself in a world of my imagination by creating art. If I'm not drawing then I'm online playing video games with friends or trying to learn something new! </p>
          </div>
        </div>
      </div>
        ...
        <div className='skills-wrapper'>
          <div className='skills-groups'>
            ...
            <div className='skill-group'>
              ...
              <div className='text-block-6'>Japanese (conversational)</div>
            </div>
            <div className='skill-group'>
